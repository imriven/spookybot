...
class IrcClient extends typed_event_emitter_1.EventEmitter {
    constructor(options) {
        ...
        if (channels) {
            this.addInternalListener(this.onRegister, async () => {
                const resolvedChannels = await (0, shared_utils_1.resolveConfigValue)(channels);
    ...
    _updateCredentials(newCredentials) {
        ...
        this._connection.onConnect(async () => {
            ...
            try {
                const [password] = await Promise.all([
                    (0, shared_utils_1.resolveConfigValue)(this._credentials.password),
                ...
                this.sendMessage(Commands_1.UserRegistration, {
                    user: (_a = this._credentials.userName) !== null && _a !== void 0 ? _a : this._credentials.nick,
                    mode: '8',
                    unused: '*',
                    realName: (_b = this._credentials.realName) !== null && _b !== void 0 ? _b : this._credentials.nick
                });
            }
            catch (e) {
