...
export function createMessage(type, params, prefix, tags, serverProperties = defaultServerProperties, isServer = false) {
    ...
    const parsedParams = {};
    if (type.PARAM_SPEC) {
        forEachObjectEntry(type.PARAM_SPEC, (paramSpec, paramName) => {
...
export class Message {
    ...
    constructor(command, params, tags, prefix, serverProperties = defaultServerProperties, rawLine, isServer = false, shouldParseParams = true) {
        this._params = [];
