...
const HelixCharityApi_1 = require("../api/helix/charity/HelixCharityApi");
const HelixChatApi_1 = require("../api/helix/chat/HelixChatApi");
const HelixClipApi_1 = require("../api/helix/clip/HelixClipApi");
const HelixEntitlementApi_1 = require("../api/helix/entitlements/HelixEntitlementApi");
...
const HelixRaidApi_1 = require("../api/helix/raids/HelixRaidApi");
...
const HelixWhisperApi_1 = require("../api/helix/whisper/HelixWhisperApi");
/** @private */
let BaseApiClient = class BaseApiClient {
    ...
    async callApi(options) {
        ...
        if (forceUser) {
            ...
            if (!accessToken) {
                throw new Error(`Tried to make an API call with a scope for user ID ${options.userId} but no token was found`);
            }
        ...
        const contextUserId = (_b = this._getUserIdFromRequestContext(options)) !== null && _b !== void 0 ? _b : options.userId;
    ...
    async _callApiUsingInitialToken(options, accessToken) {
        const { authProvider } = this._config;
