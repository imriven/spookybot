...
let HelixStream = class HelixStream extends DataObject {
    ...
    get tagIds() {
        var _a;
        return (_a = this[rawDataSymbol].tag_ids) !== null && _a !== void 0 ? _a : [];
    }
    /**
    ...
    async getTags() {
        var _a;
        return await this._client.tags.getStreamTagsByIds((_a = this[rawDataSymbol].tag_ids) !== null && _a !== void 0 ? _a : []);
    }
    /**
