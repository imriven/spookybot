...
import { createUserBlockCreateQuery, createUserBlockDeleteQuery } from "../../../interfaces/helix/user.external.mjs";
...
let HelixUserApi = HelixUserApi_1 = class HelixUserApi extends BaseApi {
    ...
    async getFollows(filter) {
        ...
        const result = await this._client.callApi({
            type: 'helix',
            url: 'users/follows',
            userId: extractUserId((_a = filter.followedUser) !== null && _a !== void 0 ? _a : filter.user),
            query: {
                ...query,
