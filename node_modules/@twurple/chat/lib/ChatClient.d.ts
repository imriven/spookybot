...
export declare class ChatClient extends EventEmitter {
     ...
     * @param msg The full message object containing all message and user information.
     */
    readonly onBan: EventBinder<[channel: string, user: string, msg: ClearChat]>;
    /**
     ...
     * @param msg The full message object containing all message and user information.
     */
    readonly onChatClear: EventBinder<[channel: string, msg: ClearChat]>;
    /**
     ...
     */
    readonly onEmoteOnly: EventBinder<[channel: string, enabled: boolean]>;
    /**
     ...
     */
    readonly onFollowersOnly: EventBinder<[channel: string, enabled: boolean, delay?: number]>;
    /**
     ...
     */
    readonly onJoin: EventBinder<[channel: string, user: string]>;
    /**
     ...
     */
    readonly onJoinFailure: EventBinder<[channel: string, reason: string]>;
    /**
     ...
     */
    readonly onPart: EventBinder<[channel: string, user: string]>;
    /**
     ...
     */
    readonly onMessageRemove: EventBinder<[channel: string, messageId: string, msg: ClearMsg]>;
    /**
     ...
     */
    readonly onR9k: EventBinder<[channel: string, enabled: boolean]>;
    /**
     ...
     * @param msg The full message object containing all message and user information.
     */
    readonly onRaidCancel: EventBinder<[channel: string, msg: UserNotice]>;
    /**
     ...
     */
    readonly onSlow: EventBinder<[channel: string, enabled: boolean, delay?: number]>;
    /**
     ...
     */
    readonly onSubsOnly: EventBinder<[channel: string, enabled: boolean]>;
    /**
     ...
     * @param msg The full message object containing all message and user information.
     */
    readonly onWhisper: EventBinder<[user: string, text: string, msg: Whisper]>;
    /**
     ...
     * @param text The message text.
     */
    readonly onNoPermission: EventBinder<[channel: string, text: string]>;
    /**
     ...
     * @param text The message text.
     */
    readonly onMessageRatelimit: EventBinder<[channel: string, text: string]>;
    /**
     * Fires when authentication succeeds.
     *
     * @eventListener
     */
    readonly onAuthenticationSuccess: EventBinder<[]>;
    /**
     ...
     * @param text The message text.
     */
    readonly onAuthenticationFailure: EventBinder<[text: string, retryCount: number]>;
    /**
     ...
     */
    readonly onMessageFailed: EventBinder<[channel: string, reason: string]>;
    /**
