 ...
 */
let TwitchPrivateMessage = class TwitchPrivateMessage extends MessageTypes.Commands.PrivateMessage {
    /**
    ...
    parseEmotesAndBits(cheermotes, cheermoteFormat) {
        const messageText = getMessageText(this.params.content);
        return parseChatMessage(messageText, this.emoteOffsets, cheermotes.getPossibleNames()).map(part => part.type === 'cheer'
            ? {
                ...part,
...
TwitchPrivateMessage = __decorate([
    rtfm('chat', 'TwitchPrivateMessage', 'id')
