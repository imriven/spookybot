...
import { TwitchPrivateMessage } from "./commands/TwitchPrivateMessage.mjs";
import { splitOnSpaces } from "./utils/messageUtil.mjs";
import { toChannelName } from "./utils/userUtil.mjs";
/**
...
let ChatClient = ChatClient_1 = class ChatClient extends EventEmitter {
    ...
    constructor(config = {}) {
        ...
        const executeJoinRequest = async (channel) => await new Promise((resolve, reject) => {
        ...
        this._ircClient.onTypedMessage(MessageTypes.Commands.Notice, async ({ params: { target: channel, content }, tags }) => {
            const messageType = tags.get('msg-id');
            switch (messageType) {
                // emote only
                case 'emote_only_on': {
