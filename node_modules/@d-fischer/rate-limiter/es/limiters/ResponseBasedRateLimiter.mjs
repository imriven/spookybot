    ...
    Object.defineProperty(ResponseBasedRateLimiter.prototype, "stats", {
        get: function () {
            ...
            return {
                ...
                lastKnownResetDate: mapNullable((_e = this._parameters) === null || _e === void 0 ? void 0 : _e.resetsAt, function (v) { return new Date(v); })
            };
        },
        enumerable: false,
        configurable: true
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (rejectedPromises.length) {
                            ...
                            retryAt = Math.max.apply(Math, __spreadArray([now], __read(rejectedPromises.map(function (p) { return p.reason.retryAt; })), false));
