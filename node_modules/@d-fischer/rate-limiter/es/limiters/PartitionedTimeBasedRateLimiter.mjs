                    ...
                    case 0: return [4 /*yield*/, new Promise(function (resolve, reject) {
                            ...
                            if (usedFromBucket >= _this._bucketSize || _this._paused) {
                                switch (reqSpec.limitReachedBehavior) {
                                    ...
                                    case 'throw': {
                                        reqSpec.reject(new RateLimitReachedError("Request dropped because the rate limit for ".concat(partitionKey ? "partition ".concat(partitionKey) : 'default partition', " was reached")));
                                        break;
                                    }
                                    default: {
