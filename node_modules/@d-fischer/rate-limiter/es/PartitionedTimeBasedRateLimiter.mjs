...
import { RateLimitReachedError } from "./RateLimitReachedError.mjs";
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        if (usedFromBucket >= _this._bucketSize) {
                            switch (reqSpec.limitReachedBehavior) {
                                ...
                                case 'throw': {
                                    reqSpec.reject(new RateLimitReachedError("Request dropped because the rate limit for partition " + partitionKey + " was reached"));
                                    break;
                                }
                                default: {
